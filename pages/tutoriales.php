...
<!doctype html>
<html lang="en" class="light-style layout-navbar-fixed layout-wide" dir="ltr" data-theme="theme-default" data-assets-path="assets/" data-template="front-pages-no-customizer">
<head>
    <meta charset="utf-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=no, minimum-scale=1.0, maximum-scale=1.0" />
    <title>Servicios de Telefonía VoIP para Empresas en Colombia - BestVoIPer</title>
    <meta name="description" content="Descubra soluciones avanzadas en telefonía VoIP e IP para su empresa en Colombia. Mejore sus comunicaciones con BestVoIPer, su aliado tecnológico." />
    <!-- Favicon -->
    ...
    <div>
            ...
            <div class="container">
                <div class="navbar navbar-expand-lg landing-navbar px-3 px-md-4">
                    ...
                    <ul class="navbar-nav flex-row align-items-center ms-auto">
                        <!-- Cerrar sesión: formulario corregido -->
                        <li>
                            <form action="../mail/cerrarSesion.php" method="POST">
        ...
        <div class="tutoriales">
            <div class="itemTutorial">
                ...
                <div>
                    <p><b>Tutorial:</b> Entrar a la plataforma</p>
                </div>
            </div>
            <div class="itemTutorial">
              <div>
