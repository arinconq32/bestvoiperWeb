...
<div class="fixed-container">
    <div class="container">
        ...
        <div class="contenedorC">
          <div  class="imagenC" >
            <img id="current-image" src="../assets/img/front-pages/landing-page/personalizacionMensaje.svg" 
            width="100%" alt="Mensajería Masiva SMS"/>
          </div>
          <div class="descripcionC">
            <h1 id="current-title">Mensajería Masiva SMS
            </h1>
            <h3 id="current-subtitle">Mensajería SMS Masiva para Empresas en Colombia</h3>
            <p id="current-paragraph" style="text-align: center;"> Entrega instantánea: Garantizamos alta tasa de recepción.
            </p>
    ...
    <section class="section" style="visibility: hidden;">
        <div class="container">
            <div class="contenedorCRM">
              <div class="imagenCRM" >
                <img src="../assets/img/front-pages/landing-page/personalizacionMensaje.svg" width="100%"
                alt="Entrega instantánea"/>
              </div>
              <div class="descripcionC">
                <h1 style="display: none;">Mensajería Masiva SMS
                </h1>
                <h3 style="display: none;">Mensajería SMS Masiva para Empresas en Colombia</h3>
                <p style="display: none;">Entrega instantánea: Garantizamos alta tasa de recepción.
                    </p>
       ...
       <section class="section" style="visibility: hidden;">
        <div class="container">
            <div class="contenedorCRM">
              <div class="imagenCRM" >
                <img src="../assets/img/front-pages/landing-page/personalizacion.svg" width="100%"
                alt="Personalización de mensajes"/>
              </div>
              <div class="descripcionC">
                <h1 style="display: none;">Mensajería Masiva SMS
                </h1>
                <h3 style="display: none;">Mensajería SMS Masiva para Empresas en Colombia</h3>
                <p style="display: none;">Personalización de mensajes: Haz que cada mensaje sea único.
                    </p>
       ...
       <section class="section" style="visibility: hidden;">
        <div class="container">
            <div class="contenedorCRM">
              <div class="imagenCRM" >
                <img src="../assets/img/front-pages/landing-page/api.svg" width="100%"
                alt="Integración API"/>
              </div>
              <div class="descripcionC">
                <h1 style="display: none;">Mensajería Masiva SMS
                ...
                <h3 style="display: none;">Mensajería SMS Masiva para Empresas en Colombia</h3>
                <p style="display: none;">Integración API: Conecta tu sistema a nuestra plataforma fácilmente.
                    </p>
      ...
      <section class="section reveal" style="visibility: hidden;">
        <div class="container">
            <div class="contenedorCRM">
                <div class="imagenCRM">
                    <img src="../assets/img/front-pages/landing-page/somos.svg" width="100%"
                    alt="Soporte 24/7"/>
                  </div>
              ...
              <div class="descripcionC">
                ...
                <h3 style="display: none;">Mensajería SMS Masiva para Empresas en Colombia</h3>
                <p style="display: none;">Soporte 24/7: Siempre a tu disposición.
                </p>
