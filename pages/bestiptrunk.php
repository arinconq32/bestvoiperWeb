...
<link href="https://fonts.googleapis.com/css2?family=Montserrat:ital,wght@0,100..900;1,100..900&family=Onest:wght@100..900&family=Open+Sans:ital,wght@0,300..800;1,300..800&display=swap" rel="stylesheet">
  ...
  <body>
    ...
    <div data-bs-spy="scroll" class="scrollspy-example">
      ...
      <div class="container2">
          ...
          <img
            src="../assets/img/front-pages/landing-page/8.svg"
            alt="bestiptrunk"
            class="imagen"
            data-app-light-img="front-pages/landing-page/8.svg"
            data-app-dark-img="front-pages/landing-page/8.svg"
          />
      ...
      <div class="container">
        ...
        <p>Servicio de troncales IP que permite <b style="font-weight: normal;background-color: rgba(116, 172, 88, 0.652); 
      color:white; line-height: 2.1rem;">conectividad a través del protocolo SIP a
          cualquier destino en el mundo,</b>con la más alta calidad y confiabilidad. Contamos con 
          sistema automático de backend, para garantizar una operación con disponibilidad del 99,9%.</p>
        </div>
        <div class="imagenCRM">
        ...
        <div class="container">
          <div class="contenedorCRM">
            <div class="imagenCRM">
              <lottie-player src="https://lottie.host/aef4e26c-5f1e-44df-be11-66e3000e54f6/Pwe3Mh7xSf.json" background="##FFFFFF" speed="1" 
              style="width: 80%; height: 80%; margin: auto;" loop autoplay direction="1" mode="normal"></lottie-player>
            </div>
          <div class="descripcionCRM" >
         
          <p><b style="font-weight: normal;background-color: rgba(116, 172, 88, 0.652); 
      color:white; line-height: 2.1rem;">Soportamos tráfico masivo y retail para las necesidades de PBXs, campañas corporativas, campañas de 
            TeleMarketing y CallCenter.</b> Nuestros planes van desde un canal hasta cientos y pueden ser ilimitados 
            o con cobros por minuto, de acuerdo a los requerimientos de su negocio.</p>
          </div>
      ...
      <h1 style="font-size: 40px; text-align: center; font-family: 'Open Sans', sans-serif; font-weight: bolder; color: #74ac58; margin-bottom: 20px;">
        CARACTERISTICAS
    </h1>
      <section style="width: 70%; margin: auto;">
        <div style="display: flex; justify-content: center; align-items: center; flex-wrap: wrap; gap: 20px;">
          <img
            src="../assets/img/front-pages/landing-page/IPTRUNK1.svg"
            style="width: 350px"
            alt="Planes ilimitados o por consumo" />
          <img
            src="../assets/img/front-pages/landing-page/IPTRUNK2.svg"
            style="width: 350px"
            alt="Disponibilidad de canales" />
          <img
            src="../assets/img/front-pages/landing-page/IPTRUNK3.svg"
            style="width: 350px"
            alt="Trafico masivo y retail" />
          <img
            src="../assets/img/front-pages/landing-page/IPTRUNK4.svg"
            style="width: 350px"
            alt="Generar y exportar reportes de llamada" />
          <img
            src="../assets/img/front-pages/landing-page/IPTRUNK5.svg"
            style="width: 350px"
            alt="Campañas de contacto masivo" />
        </div>
      </section>
      <!-- Our great team: End -->
      ...
      <section style="width: 100%; display: flex; justify-content: center; align-items: center; flex-direction: column; margin: 0;">
        <h1 style="font-size: 40px; text-align: center; font-family: 'Open Sans', sans-serif; font-weight: bolder; color: #5579b7; margin-bottom: 20px;">
            ADQUIERE BESTIPTRUNK AHORA MISMO
        </h1>
        <!--
  ...
  <script>
    var animation = lottie.loadAnimation({
        ...
        path: '../assets/img/front-pages/landing-page/world.json' // Ruta del archivo JSON de la animación Lottie
    });
</script>
</html>
