    ...
    <div data-bs-spy="scroll" class="scrollspy-example">
      <!-- Hero: Start -->
        ...
        <section >
          ...
          <div class="container2">
              ...
              <img
                src="../assets/img/front-pages/landing-page/4.svg"
                alt="best did"
                class="imagen"
                data-app-light-img="front-pages/landing-page/4.svg"
                data-app-dark-img="front-pages/landing-page/4.svg"
              />
        ...
        <div class="container">
          ...
          <div class="imagenCRM">
            ...
            <img src="../assets/img/front-pages/landing-page/contact_description.svg" 
            style="width: 90%; height: 80%;margin: auto;" alt="centraliza comunicación cliente-empresa"/>
          </div>
          <div class="descripcionCRM">
         
            <p >Es un sistema profesional que centraliza todos los canales de comunicación cliente-empresa, y empresa-cliente.</p>
            </div>
        </div>
          </div>
      ...
      <section id="somos" class="section-py landing-features">
        <div class="container">
          ...
          <div>
            <img src="../assets/img/front-pages/landing-page/BESTCONTACT.svg" alt="CRS Sistema de enrutamiento de operador, wharspp, telegram, mensajes de texto, chat, redes sociales" />
            
          </div>
          <div>
            <img src="../assets/img/front-pages/landing-page/CONTACTCENTER_diagrama.svg" alt="modulo agentes, asistente virtual, marketing, autenticación, agendamiento de citas, digitalización inteligente de documentos" />
          </div>
...
<div class="imagenCRM">
  ...
  speed="1" style="width: 80%; height: 80%;margin: auto;" alt="pasarelas de pago" loop  autoplay direction="1" mode="normal"></lottie-player>
</div>
</div>
</div>
...
<div class="container">
  <div class="contenedorCRM">
    <div class="imagenCRM">
      <lottie-player src="https://lottie.host/b4f99d07-7ecc-4019-a7ef-b9ae833cf293/HCFL2P8P5u.json" background="##FFFFFF" 
      speed="1" style="width: 80%; height: 80%;margin: auto;"
      alt="geolocalización de puntos de atención" loop autoplay direction="1" mode="normal"></lottie-player>
    </div>
  <div class="descripcionCRM">
  ...
  <div class="container">
    ...
    <div class="imagenCRM">
      ...
      alt="rastreo de pedidos" loop  autoplay direction="1" mode="normal"></lottie-player>
    </div>
  </div>
    </div>
      ...
      <section style="width: 70%; margin: auto;">
        <div style="display: flex; justify-content: center; align-items: center; flex-wrap: wrap; gap: 20px;">
          <img
            src="../assets/img/front-pages/landing-page/valorAgregado1.svg"
            style="width: 450px"
            alt="Encuesta de satisfacción" />
          <img
            src="../assets/img/front-pages/landing-page/valorAgregado2.svg"
            style="width: 450px"
            alt="Módulo de agentes" />
          <img
            src="../assets/img/front-pages/landing-page/valorAgregado3.svg"
            style="width: 450px"
            alt="Módulo de reportes y administración" />
          <img
            src="../assets/img/front-pages/landing-page/valorAgregado4.svg"
            style="width: 450px"
            alt="BOT d epruebas y SLAs" />
          <img
          src="../assets/img/front-pages/landing-page/valorAgregado5.svg"
            style="width: 450px"
            alt="Consultoria POSTVENTA" />
        </div>
      </section>
    </div>
    ...
    <h1 class="text-center mb-1" style="color: #74ac58; font-weight: bolder;">CON NUESTRO AGENTE VIRTUAL PUEDES:</h1>
          ...
          <div id="slider-container">
            <div id="slider">
              ...
              <div class="slide">
                <img src="../assets/img/front-pages/landing-page/VENTAJASBESTCONTACT1.svg" alt="Gestionar tus oportunidades e incrementar el porcentaje de conversión" style="width: 100%; height: 800px;">
              </div>
          
              <div class="slide">
                <img src="../assets/img/front-pages/landing-page/VENTAJASBESTCONTACT2.svg" alt="Mejorar la experiencia de usuario de tus clientes" style="width: 100%; height: 800px;">
              </div>
          
              <div class="slide">
                <img src="../assets/img/front-pages/landing-page/VENTAJASBESTCONTACT3.svg" alt="Ofrecer disponibilidad 24/7" style="width: 100%; height: 800px;">
              </div>
          
              <div class="slide">
                <img src="../assets/img/front-pages/landing-page/VENTAJASBESTCONTACT4.svg" alt="Brindar atención inmediata" style="width: 100%; height: 800px;">
              </div>
          
              <div class="slide">
                <img src="../assets/img/front-pages/landing-page/VENTAJASBESTCONTACT5.svg" alt="Gestionar tu base de datos" style="width: 100%; height: 800px;">
              </div>
          
              <!-- Duplicamos los slides para crear un efecto infinito -->
              <div class="slide">
                <img src="../assets/img/front-pages/landing-page/VENTAJASBESTCONTACT6.svg" alt="Obtener reportes y metricas" style="width: 100%; height: 800px;">
              </div>
          
              <div class="slide">
                <img src="../assets/img/front-pages/landing-page/VENTAJASBESTCONTACT7.svg" alt="Optimizar tus costos e incrementar tus ingresos" style="width: 100%; height: 800px;">
              </div>
          
              <div class="slide">
                <img src="../assets/img/front-pages/landing-page/VENTAJASBESTCONTACT8.svg" alt="Incrementar la productividad de tu equipo comercial" style="width: 100%; height: 800px;">
              </div>
          
              <div class="slide">
                <img src="../assets/img/front-pages/landing-page/VENTAJASBESTCONTACT9.svg" alt="Medir el nivel de satisfacción de tus clientes" style="width: 100%; height: 800px;">
              </div>
          
              <div class="slide">
                <img src="../assets/img/front-pages/landing-page/VENTAJASBESTCONTACT10.svg" alt="Medir el nivel de satisfacción de tus clientes" style="width: 100%; height: 800px;">
              </div>
            </div>
      ...
      <div class="robot">
        <div class="imagenRobot">
          <img src="../assets/img/front-pages/landing-page/robot.svg" />
        </div>
        <div class="textoRobot">
          <p>
      ...
      <section style="width: 100%; display: flex; justify-content: center; align-items: center; flex-direction: column; margin: 0;">
        <h1 style="font-size: 40px; text-align: center; font-family: 'Open Sans', sans-serif; font-weight: bolder; color: #5579b7; margin-bottom: 20px;">
            ADQUIERE BESTCONTACTCENTER AHORA MISMO
        </h1>
        <!--
        <form className="checkout" >
            <script
                ...
                data-epayco-amount="300.000"
                data-epayco-name="BestCallCenterPro"
                ...
                data-epayco-response="https://localhost:3000/feedback"
                data-epayco-confirmation="https://localhost:3000/feedback"
      ...
      <div class="container">
        <div class="row gx-0 gy-4 g-md-5">
          <div class="d-flex justify-content-between align-items-center w-100" >
            ...
            <a href="/paginaweb/index.php" class="app-brand-link mb-4 d-flex align-items-center">
              <span class="app-brand-logo demo">
                <img src="../assets/img/branding/LOGOBESTVOIPER.png" width="35" alt="bestvoiper comunicaciones"/>
              </span>
