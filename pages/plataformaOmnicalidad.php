...
<div class="fixed-container">
    <div class="container">
        ...
        <div class="contenedorC">
          <div  class="imagenC" >
            <img id="current-image" src="../assets/img/front-pages/landing-page/integracionRedes.svg" width="100%" alt="Plataforma de Omnicanalidad"/>
          </div>
          <div class="descripcionC">
            <h1 id="current-title">Plataforma de Omnicanalidad
            </h1>
            <h3 id="current-subtitle">Conecta WhatsApp, Redes Sociales y tu Sitio Web en una Plataforma Omnicanal</h3>
            <p id="current-paragraph" style="text-align: center;">Integración de redes sociales: Responde mensajes de 
              Facebook, Instagram y más desde un solo lugar.</p>
              <div class="descripcionCRM">
                <a href="contacto.php"><p>¡Transforma la experiencia de tus clientes! Solicita más información ahora.</p></a>
            </div>
          </div>
        </div>
    </div>
  ...
  <section class="section" style="visibility: hidden;">
      <div class="container">
          <div class="contenedorCRM">
            <div class="imagenCRM" >
              <img src="../assets/img/front-pages/landing-page/integracionRedes.svg" width="100%" alt="Integración de redes sociales"/>
            </div>
            <div class="descripcionC">
              <h1 style="display: none;">Plataforma de Omnicanalidad
              </h1>
              <h3 style="display: none;">Conecta WhatsApp, Redes Sociales y tu Sitio Web en una Plataforma Omnicanal</h3>
              <p style="display: none;">Integración de redes sociales: Responde mensajes de 
                Facebook, Instagram y más desde un solo lugar.
                  </p>
...
<div class="content">
    <section class="section" style="visibility: hidden;">
        <div class="container">
            <div class="contenedorCRM">
              <div class="imagenCRM" >
                <img src="../assets/img/front-pages/landing-page/chat.svg" width="100%" alt="Chat en vivo para tu web"/>
              </div>
              <div class="descripcionC">
                <h1 style="display: none;">Plataforma de Omnicanalidad
                </h1>
                <h3 style="display: none;">Conecta WhatsApp, Redes Sociales y tu Sitio Web en una Plataforma Omnicanal</h3>
                <p style="display: none;">Chat en vivo para tu web: Mejora la experiencia de tus visitantes.
                    </p>
...
<div class="content">
  <section class="section" style="visibility: hidden;">
      <div class="container">
          <div class="contenedorCRM">
            <div class="imagenCRM" >
              <img src="../assets/img/front-pages/landing-page/crm.svg" width="100%" alt="Sincronización con CRM y métricas avanzadas"/>
            </div>
            <div class="descripcionC">
              <h1 style="display: none;">Plataforma de Omnicanalidad
              </h1>
              <h3 style="display: none;">Conecta WhatsApp, Redes Sociales y tu Sitio Web en una Plataforma Omnicanal</h3>
              <p style="display: none;">Sincronización con CRM y métricas avanzadas: Toda tu información centralizada.s
                  </p>
...
<div class="content">
  <section class="section" style="visibility: hidden;">
      <div class="container">
          <div class="contenedorCRM">
            <div class="imagenCRM" >
              <img src="../assets/img/front-pages/landing-page/soporte.svg" width="100%" alt="Soporte en tiempo real"/>
            </div>
            <div class="descripcionC">
              <h1 style="display: none;">Plataforma de Omnicanalidad
              </h1>
              <h3 style="display: none;">Conecta WhatsApp, Redes Sociales y tu Sitio Web en una Plataforma Omnicanal</h3>
              <p style="display: none;">Soporte en tiempo real: Resuelve cualquier inconveniente al instante.
                  </p>
