...
.slide1 {
  ...
  opacity: 0.8; /* Hace los slides laterales un poco más transparentes */
    ...
    color:#74ac58; margin-bottom: 1%;margin-top: 8%;">FUNCIONALIDADES SALUD</h1>
   
        <div id="slider-container">
          <div id="slider">
            <!-- Duplicar los slides al principio y al final para crear un efecto infinito -->
            <div class="slide">
              <img src="../../assets/img/front-pages/landing-page/FUNCIONALIDADSEGUROS8.svg" alt="Imagen 1" style="width: 100%; height: 800px;">
            </div>
        
            <div class="slide">
              <img src="../../assets/img/front-pages/landing-page/FUNCIONALIDADSALUD1.svg" alt="Imagen 3" style="width: 100%; height: 800px;">
            </div>
        
            <div class="slide">
              <img src="../../assets/img/front-pages/landing-page/FUNCIONALIDADSALUD2.svg" alt="Imagen 4" style="width: 100%; height: 800px;">
            </div>
        
            <div class="slide">
              <img src="../../assets/img/front-pages/landing-page/FUNCIONALIDADSALUD3.svg" alt="Imagen 5" style="width: 100%; height: 800px;">
            </div>
        
            <!-- Duplicamos los slides para crear un efecto infinito -->
            <div class="slide">
              <img src="../../assets/img/front-pages/landing-page/FUNCIONALIDADSALUD4.svg" alt="Imagen 1" style="width: 100%; height: 800px;">
            </div>
        
            <div class="slide">
              <img src="../../assets/img/front-pages/landing-page/FUNCIONALIDADSALUD5.svg" alt="Imagen 2" style="width: 100%; height: 800px;">
            </div>
            <div class="slide">
              <img src="../../assets/img/front-pages/landing-page/FUNCIONALIDADTURISMO6.svg" alt="Imagen 2" style="width: 100%; height: 800px;">
            </div>
            <div class="slide">
              <img src="../../assets/img/front-pages/landing-page/FUNCIONALIDADTURISMO6.svg" alt="Imagen 2" style="width: 100%; height: 800px;">
            </div>
