      ...
      <div class="container">
        ...
        <div id="slider-container">
          <div id="slider">
            ...
            <div class="slide">
              <img src="../../assets/img/front-pages/landing-page/FUNCIONALIDADSOPORTE1.svg" alt="Reporte de casos" style="width: 100%; height: 800px;">
            </div>
        
            <div class="slide">
              <img src="../../assets/img/front-pages/landing-page/FUNCIONALIDADSOPORTE2.svg" alt="Seguimiento de casos" style="width: 100%; height: 800px;">
            </div>
        
            <div class="slide">
              <img src="../../assets/img/front-pages/landing-page/FUNCIONALIDADSOPORTE3.svg" alt="Soporte técnico con ayudas visuales" style="width: 100%; height: 800px;">
            </div>
        
            <div class="slide">
              <img src="../../assets/img/front-pages/landing-page/FUNCIONALIDADSOPORTE4.svg" alt="Solicitud de documentos" style="width: 100%; height: 800px;">
            </div>
        
            <div class="slide">
              <img src="../../assets/img/front-pages/landing-page/FUNCIONALIDADSOPORTE5.svg" alt="solicitud de licencias y vacaciones" style="width: 100%; height: 800px;">
            </div>
        
            <!-- Duplicamos los slides para crear un efecto infinito -->
            <div class="slide">
              <img src="../../assets/img/front-pages/landing-page/FUNCIONALIDADSOPORTE6.svg" alt="Reporte de incidentes" style="width: 100%; height: 800px;">
            </div>
            <div class="slide">
