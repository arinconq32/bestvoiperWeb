      ...
      <div class="container">
        ...
        <div id="slider-container">
          <div id="slider">
            ...
            <div class="slide">
              <img src="../../assets/img/front-pages/landing-page/FUNCIONALIDADFINANCIEROS1.svg" alt="Información de productos: Caracteristicas, requisitos, saldos, cartera, fecha de pago" style="width: 100%; height: 800px;">
            </div>
        
            <div class="slide">
              <img src="../../assets/img/front-pages/landing-page/FUNCIONALIDADFINANCIEROS2.svg" alt="verificación de identidad para transacciones" style="width: 100%; height: 800px;">
            </div>
        
            <div class="slide">
              <img src="../../assets/img/front-pages/landing-page/FUNCIONALIDADFINANCIEROS3.svg" alt="Solicitud de cobranza" style="width: 100%; height: 800px;">
            </div>
        
            <div class="slide">
              <img src="../../assets/img/front-pages/landing-page/FUNCIONALIDADFINANCIEROS4.svg" alt="Solicitud de productos" style="width: 100%; height: 800px;">
            </div>
        
            <div class="slide">
              <img src="../../assets/img/front-pages/landing-page/FUNCIONALIDADFINANCIEROS5.svg" alt="Solicitud de documentos, extractos, certificaciones, movimientos" style="width: 100%; height: 800px;">
            </div>
        
            <!-- Duplicamos los slides para crear un efecto infinito -->
            <div class="slide">
              <img src="../../assets/img/front-pages/landing-page/FUNCIONALIDADFINANCIEROS6.svg" alt="Pago de obligaciones" style="width: 100%; height: 800px;">
            </div>
        
            <div class="slide">
              <img src="../../assets/img/front-pages/landing-page/FUNCIONALIDADFINANCIEROS7.svg" alt="Información de sucursales y cajerps más cercanos" style="width: 100%; height: 800px;">
            </div>
            <div class="slide">
              <img src="../../assets/img/front-pages/landing-page/FUNCIONALIDADFINANCIEROS8.svg" alt="Más funcionalidades según necesidad del cliente" style="width: 100%; height: 800px;">
            </div>
            <div class="slide">
              <img src="../../assets/img/front-pages/landing-page/FUNCIONALIDADFINANCIEROS7.svg" alt="Imagen 2" style="width: 100%; height: 800px;">
            </div>
