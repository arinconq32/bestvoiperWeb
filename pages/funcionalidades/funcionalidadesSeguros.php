      ...
      <div class="container">
        ...
        <div id="slider-container">
          <div id="slider">
            ...
            <div class="slide">
              <img src="../../assets/img/front-pages/landing-page/FUNCIONALIDADSEGUROS1.svg" alt="Información de Polizas, tipos de polizas" style="width: 100%; height: 800px;">
            </div>
        
            <div class="slide">
              <img src="../../assets/img/front-pages/landing-page/FUNCIONALIDADSEGUROS2.svg" alt="Reporte de Siniestros" style="width: 100%; height: 800px;">
            </div>
        
            <div class="slide">
              <img src="../../assets/img/front-pages/landing-page/FUNCIONALIDADSEGUROS3.svg" alt="Pagos en linea" style="width: 100%; height: 800px;">
            </div>
        
            <div class="slide">
              <img src="../../assets/img/front-pages/landing-page/FUNCIONALIDADSEGUROS4.svg" alt="Estado de pago de siniestro" style="width: 100%; height: 800px;">
            </div>
        
            <!-- Duplicamos los slides para crear un efecto infinito -->
            <div class="slide">
              <img src="../../assets/img/front-pages/landing-page/FUNCIONALIDADSEGUROS5.svg" alt="Venta de seguros" style="width: 100%; height: 800px;">
            </div>
        
            <div class="slide">
              <img src="../../assets/img/front-pages/landing-page/FUNCIONALIDADSEGUROS6.svg" alt="Administración de solicitudes" style="width: 100%; height: 800px;">
            </div>
            <div class="slide">
              <img src="../../assets/img/front-pages/landing-page/FUNCIONALIDADSEGUROS7.svg" alt="Solicitudes de servicios" style="width: 100%; height: 800px;">
            </div>
            <div class="slide">
              <img src="../../assets/img/front-pages/landing-page/FUNCIONALIDADFINANCIEROS8.svg" alt="Más funcionalidades segun neceisdad del cliente" style="width: 100%; height: 800px;">
            </div>
            <div class="slide">
