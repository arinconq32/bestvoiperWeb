...
<div class="fixed-container">
    <div class="container">
        ...
        <div class="contenedorC">
          <div  class="imagenC" >
            <img id="current-image" src="../assets/img/front-pages/landing-page/integrar.svg" width="100%"
            alt="Bajos costos por minuto"/>
          </div>
          <div class="descripcionC">
            <h1 id="current-title">Telefonía VoIP Empresarial
            </h1>
            <h3 id="current-subtitle">Características principales:</h3>
            <p id="current-paragraph" style="text-align: center;">Bajos costos por minuto: Optimiza tu presupuesto de comunicación.</p>
            <div class="descripcionCRM">
              <a href="contacto.php"><p>¡Contáctanos ahora!</p></a>
               </div>
          </div>
        </div>
    </div>
    ...
    <section class="section" style="visibility: hidden;">
        <div class="container">
            <div class="contenedorCRM">
              <div class="imagenCRM" >
                <img src="../assets/img/front-pages/landing-page/integrar.svg" width="100%"
                alt="Sincronización completa para call centers y empresas"/>
              </div>
              <div class="descripcionC">
                <h1 style="display: none;">Telefonía VoIP Empresarial
                </h1>
                <h3 style="display: none;">Características principales:</h3>
                <p style="display: none;">Integración con tu CRM: Sincronización completa para call centers y empresas.
                </p>
       ...
       <section class="section" style="visibility: hidden;">
        <div class="container">
            <div class="contenedorCRM">
              <div class="imagenCRM" >
                <img src="../assets/img/front-pages/landing-page/escalabilidad.svg" width="100%" alt="escalabilidad para empresas"/>
              </div>
              <div class="descripcionC">
                <h1 style="display: none;">Telefonía VoIP Empresarial
                </h1>
                <h3 style="display: none;">Características principales:</h3>
                <p style="display: none;">Escalabilidad: Diseñado para empresas de todos los tamaños.
                </p>
       ...
       <section class="section" style="visibility: hidden;">
        <div class="container">
            <div class="contenedorCRM">
              <div class="imagenCRM" >
                <img src="../assets/img/front-pages/landing-page/soporte.svg" width="100%"
              ...
              <div class="descripcionC">
                ...
                <h3 style="display: none;">Características principales:</h3>
                <p style="display: none;">Soporte en tiempo real: Nuestro equipo está siempre listo para ayudarte.
