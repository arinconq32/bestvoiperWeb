    ...
    <div data-bs-spy="scroll" class="scrollspy-example">
      ...
      <section >
        ...
        <div class="container2">
            ...
            <img
              src="../assets/img/front-pages/landing-page/5.svg"
              alt="best did"
              class="imagen"
              data-app-light-img="front-pages/landing-page/5.svg"
              data-app-dark-img="front-pages/landing-page/5.svg"
            />
      ...
      <div class="container">
        ...
        <div class="imagenCRM">
            ...
            <img src="../assets/img/front-pages/landing-page/did_2.svg" 
            style="width: 90%; height: 80%;margin: auto;" alt="Servicio de numeración telefónica para las principales ciudades del mundo"/>
          </div>
          <div class="descripcionCRM">
       
          <p>   Servicio de numeración telefónica para las principales ciudades del mundo. <b style="font-weight: normal;background-color: rgba(116, 172, 88, 0.652); 
      color:white; line-height: 2.1rem;">Permite recibir llamadas 
            de sus clientes sin importar el país donde se encuentren,</b> presencia a nivel mundial</p>
          </div>
          </div>
        </div>
      ...
      <section id="somos" class="section-py landing-features">
          ...
          <div style="width: 80%; margin: auto">
            <img src="../assets/img/front-pages/landing-page/diagramadid.svg"
            alt="Permite recibir llamadas 
            de sus clientes sin importar el país donde se encuentren"/>
          </div>
          <h1 class="text-center mb-1" style="color: #74ac58; font-weight: bolder;">CARACTERISTICAS</h1>
              ...
              <div id="slider-container">
                <div id="slider">
                  ...
                  <div class="slide">
                    <img src="../assets/img/front-pages/landing-page/DID1.svg" alt="Capacidad para recibir llamadas simultaneas desde dos canales en adelante" style="width: 100%; height: 800px;">
                  </div>
              
                  <div class="slide">
                    <img src="../assets/img/front-pages/landing-page/DID2.svg" alt="Transferir llamadas por ip a una pbx o remarcar a cualquier número telefonico en el mundo" style="width: 100%; height: 800px;">
                  </div>
              
                  <div class="slide">
                    <img src="../assets/img/front-pages/landing-page/DID3.svg" alt="Generar reportes de todas las llamadas recibidas" style="width: 100%; height: 800px;">
                  </div>
              
                  <div class="slide">
                    <img src="../assets/img/front-pages/landing-page/DID4.svg" alt="Posibilidad de hacer portabilidad" style="width: 100%; height: 800px;">
                  </div>
                  <div class="slide">
                    <img src="../assets/img/front-pages/landing-page/DID1.svg" alt="Capacidad para recibir llamadas simultaneas desde dos canales en adelante" style="width: 100%; height: 800px;">
                  </div>
      ...
      <section style="width: 100%; display: flex; justify-content: center; align-items: center; flex-direction: column; margin: 0;">
        <h1 class="text-center mb-1" style="color: #5579b7; font-weight: bolder;">ADQUIERE BEST DID AHORA MISMO</h1>
        <!--
