    ...
    <div class="container">
        ...
        <div class="contenedorC">
          <div  class="imagenC" >
            ...
            src="../assets/img/front-pages/landing-page/crm1.svg" width="100%" alt="CRM Omnicanal con WebRTC"/>
          </div>
          <div class="descripcionC">
            <h1 id="current-title">CRM Omnicanal con WebRTC
            </h1>
            <h3 id="current-subtitle">CRM Omnicanal con WebRTC, WhatsApp y Métricas Avanzadas para Call Centers</h3>
            <p id="current-paragraph" style="text-align: center;">Nuestro CRM omnicanal integra de forma nativa APIs de llamadas entrantes y salientes,
                 WebRTC para comunicaciones en tiempo real, WhatsApp, redes sociales, y chats desde tu página web.

                 </p>
                 <div class="descripcionCRM">
                <a href="contacto.php"><p>¡Solicita una demo gratuita y transforma tu negocio con BestVoIPer!</p></a>
                 </div>
...
<div class="content">
    <section class="section" style="visibility: hidden;">
        <div class="container">
            <div class="contenedorCRM">
              <div class="imagenCRM" >
                <img src="../assets/img/front-pages/landing-page/reportePersonalizado.svg" 
                width="100%" alt="WebRTC, WhatsApp y Métricas Avanzadas para Call Centers"/>
              </div>
              <div class="descripcionC">
                <h1 style="display: none;">CRM Omnicanal con WebRTC
                </h1>
                <h3 style="display: none;">CRM Omnicanal con WebRTC, WhatsApp y Métricas </h3>
                <p style="display: none;">Avanzadas para Call Centers
                    </p>
       ...
       <section class="section" style="visibility: hidden;">
        <div class="container">
            <div class="contenedorCRM">
              <div class="imagenCRM" >
                <img src="../assets/img/front-pages/landing-page/crm1.svg" width="100%"
                img="Integra de forma nativa APIs de llamadas entrantes y salientes, webrtc"/>
              </div>
              <div class="descripcionC">
                <h1 style="display: none;">CRM Omnicanal con WebRTC
                </h1>
                <h3 style="display: none;">
                  Integra de forma nativa APIs de llamadas entrantes y salientes</h3>
       ...
       <section class="section" style="visibility: hidden;">
        <div class="container">
            <div class="contenedorCRM">
              <div class="imagenCRM" >
                <img src="../assets/img/front-pages/landing-page/chat_.svg" width="100%"
                alt="Diseñado especialmente para call centers y empresas que buscan centralizar su 
                  comunicación."/>
              </div>
              <div class="descripcionC">
                <h1 style="display: none;">CRM Omnicanal con WebRTC
                </h1>
                <h3 style="display: none;">Diseñado especialmente para call centers y empresas que buscan centralizar su 
                  comunicación.</h3>
                <p style="display: none;"> 
    
                  Integración de WhatsApp Business API: Responde a tus clientes desde una plataforma única.
                 </p>
       ...
       <section class="section" style="visibility: hidden;">
        <div class="container">
            <div class="contenedorCRM">
              <div class="imagenCRM" >
                <img src="../assets/img/front-pages/landing-page/rendimientoAgentes.svg" 
                width="100%" alt="Monitorea en tiempo real el rendimiento de tus agentes."/>
              </div>
              <div class="descripcionC">
                <h1 style="display: none;">CRM Omnicanal con WebRTC
                </h1>
                <h3 style="display: none;">Métricas especializadas para call centers:</h3>
                <p style="display: none;"> 
                 
                   Monitorea en tiempo real el rendimiento de tus agentes.
                  </p>
       ...
       <section class="section" style="visibility: hidden;">
        <div class="container">
            <div class="contenedorCRM">
              <div class="imagenCRM" >
                <img src="../assets/img/front-pages/landing-page/altaDisponibilidad.svg"
                 width="100%" alt="La mejor relación calidad-precio en el mercado"/>
              </div>
              <div class="descripcionC">
                <h1 style="display: none;">CRM Omnicanal con WebRTC
                </h1>
                <h3 style="display: none;">Alta disponibilidad: Garantizamos la continuidad de tu servicio.
                  Bajos costos: La mejor relación calidad-precio en el mercado.</h3>
                <p style="display: none;"> 
