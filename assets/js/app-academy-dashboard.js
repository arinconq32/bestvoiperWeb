...
(function () {
  ...
  if (dt_academy_course.length) {
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            var $row_output =
              ...
              '</span>' +
              '<div>' +
              '<a class="text-heading text-truncate fw-medium mb-2 text-wrap" href="app-academy-course-details.php">' +
              $course +
              '</a>' +
    ...
    $('div.head-label').php('<h5 class="card-title mb-0 text-nowrap">Course you are taking</h5>');
  }
